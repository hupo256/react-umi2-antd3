...
@Form.create()
class YesSettlement extends Component {
  constructor(props) {
  ...
  columns = [
    ...
    {
      title: '最终结算人',
      dataIndex: 'final_settlement_people',
      key: 'final_settlement_people',
      width: 200,
      render: text => {
        if (text == '否') {
          return <span style={{ color: 'red' }}>{text}</span>;
    ...
    {
      title: '最终结算时间',
      dataIndex: 'final_settlement_time',
      key: 'final_settlement_time',
      width: 200,
    },
  ];
